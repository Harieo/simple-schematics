...
public class SoundTransitionDeserializer extends TransitionJsonDeserializer {
	...
	@Override
	public SoundTransition deserializeToSpecific(@NotNull JsonObject serializedObject, long millisecondsBefore,
	...
	public boolean isValidObject(@NotNull JsonObject serializedObject) {
		return serializedObject.has("sound") && serializedObject.has("location")
